#Exercises for Section 4 - 'Practice Problems: Medium 2'
...
# pumpkins. += creates a new object and reasigns the local variable name a_string_param to it. a_string_param and my_string now point to two different objects.
# ['pumpkins', 'rutabaga']. << is a method that mutates the caller.
...
# 'pumpkinsrutaba', ['pumpkins']. Similar reasons as before.
