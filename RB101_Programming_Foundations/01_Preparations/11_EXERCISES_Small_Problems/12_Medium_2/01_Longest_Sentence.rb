...
text = File.read('C:\Users\Justin\Google Drive\LaunchSchool\RB101.1.11_Small_Problems_Exercises\12_Medium_2\pg84.txt')
sentences = text.split(/\.|\?|!/)
longest_sentence = sentences.max_by { |sentence| sentence.split.size }

puts "#{longest_sentence} is the longest sentence at #{longest_sentence.size} words!"